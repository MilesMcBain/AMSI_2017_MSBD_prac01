...
write.parquet(m4_data, path = "./data/m4_parquet")

parquet_test <- read.parquet(sqlContext, path = "./data/m4_parquet")
showDF(parquet_test, 100)
```
...
* How might you use `./data/RouteLengthApprox.csv` for further preprocessing?
